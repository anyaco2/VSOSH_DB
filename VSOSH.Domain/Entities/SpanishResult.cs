...
/// <summary>
/// Представляет результат олимпиады по испанскому языку.
/// </summary>
public class SpanishResult : SchoolOlympiadResultBase
{
	#region .ctor
	/// <summary>
	/// Инициализирует экземпляр класса <see cref="SpanishResult" />.
	/// </summary>
