...
/// <summary>
/// Представляет результат олимпиады по биологии.
/// </summary>
public class BiologyResult : SchoolOlympiadResultBase
{
    #region .ctor
    /// <summary>
    /// Инициализирует эксемпляр класса <see cref="BiologyResult" />.
    /// </summary>
    ...
    public BiologyResult(Guid id, string school, string participantCode, StudentName studentName, string status, double percentage, double finalScore, int currentGrade, int gradeCompeting) 
