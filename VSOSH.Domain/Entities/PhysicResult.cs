...
/// <summary>
/// Представляет результат олимпиады по физике.
/// </summary>
public class PhysicResult : SchoolOlympiadResultBase
{
    ...
    public PhysicResult(Guid id, string school, string participantCode, StudentName studentName, string status, double percentage, double finalScore, int currentGrade, int gradeCompeting) 
