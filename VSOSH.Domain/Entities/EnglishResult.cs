...
public class EnglishResult : SchoolOlympiadResultBase
{
    ...
    public EnglishResult(Guid id, string school, string participantCode, StudentName studentName, string status, double percentage, double finalScore, int currentGrade, int gradeCompeting) 
