...
/// <summary>
/// Представляет результат олимпиады по астрономие.
/// </summary>
public class AstronomyResult : SchoolOlympiadResultBase
{
    #region .ctor
    /// <summary>
    /// Инициализирует эксемпляр класса <see cref="AstronomyResult" />.
    /// </summary>
    ...
    public AstronomyResult(Guid id, string school, string participantCode, StudentName studentName, string status, double percentage, double finalScore, int currentGrade, int gradeCompeting) 
