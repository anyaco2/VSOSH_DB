...
/// <summary>
/// Представляет результат олимпиады по математике.
/// </summary>
public class MathResult : SchoolOlympiadResultBase
{
    #region .ctor
    /// <summary>
    /// Инициализирует эксемпляр класса <see cref="MathResult" />.
    /// </summary>
    ...
    public MathResult(Guid id, string school, string participantCode, StudentName studentName, string status, double percentage, double finalScore, int currentGrade, int gradeCompeting) 
