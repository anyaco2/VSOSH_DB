...
/// <summary>
/// Представляет результат олимпиады по праву.
/// </summary>
public class LawResult : SchoolOlympiadResultBase
{
    #region .ctor
    /// <summary>
    /// Инициализирует эксемпляр класса <see cref="LawResult" />.
    /// </summary>
    ...
    public LawResult(Guid id, string school, string participantCode, StudentName studentName, string status, double percentage, double finalScore, int currentGrade, int gradeCompeting) 
