...
namespace VSOSH.Dal.Migrations
{
    ...
    [Migration("20251203195941_AddItalianResultTable")]
    partial class AddItalianResultTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VSOSH.Domain.Entities.Protocol", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VSOSH.Domain.Entities.ItalianResult", b =>
                {
                    b.HasBaseType("VSOSH.Domain.Entities.SchoolOlympiadResultBase");

                    b.ToTable("ItalianResults", (string)null);
                });
            ...
            modelBuilder.Entity("VSOSH.Domain.Entities.SpanishResult", b =>
                {
                    b.HasBaseType("VSOSH.Domain.Entities.SchoolOlympiadResultBase");

                    b.ToTable("SpanishResults", (string)null);
                });
            ...
            modelBuilder.Entity("VSOSH.Domain.Entities.SchoolOlympiadResultBase", b =>
                {
                    b.HasOne("VSOSH.Domain.Entities.Protocol", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VSOSH.Domain.Entities.ItalianResult", b =>
                {
                    b.HasOne("VSOSH.Domain.Entities.SchoolOlympiadResultBase", null)
                        .WithOne()
                        .HasForeignKey("VSOSH.Domain.Entities.ItalianResult", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("VSOSH.Domain.Entities.SpanishResult", b =>
                {
                    b.HasOne("VSOSH.Domain.Entities.SchoolOlympiadResultBase", null)
                        .WithOne()
                        .HasForeignKey("VSOSH.Domain.Entities.SpanishResult", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
